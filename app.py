...
def get_captions(url):
    ...
    if captions:
        ...
        st.session_state.captions["srt_speakers"] = captions[4]
...
def run():
    ...
    if st.session_state.youtube_player:
        ...
        if caption_choice == "srt":
            if speakers:
                srt_captions_dict = parse_srt(st.session_state.captions["srt_speakers"])
            else:
            ...
            if st.session_state.youtube_player["data"]["played"] > 0:
                ...
                st.text(st.session_state.captions["srt_speakers"] if speakers else st.session_state.captions["srt"])

        elif caption_choice == "webvtt":
            if speakers:
            ...
            if st.session_state.youtube_player["data"]["played"] > 0:
                ...
                st.text(st.session_state.captions["webvtt_speakers"] if speakers else st.session_state.captions["webvtt"])
